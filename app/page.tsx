...
export default function Home() {
  ...
  const updateStep = useCallback(() => {
    ...
    if (firstCardRef.current) {
      ...
      const parent = firstCardRef.current;
  ...
  return (
    <SmoothScroll>
      <div className="relative min-h-screen font-sans selection:bg-[#007FFF]/30 overflow-x-hidden cursor-none">
        ...
        <div className="fixed inset-0 -z-20 bg-gradient-to-b from-[#007FFF]/5 via-transparent to-transparent pointer-events-none" />
          ...
          <motion.div style={{ opacity: heroOpacity, scale: heroScale, y: heroY }} className="max-w-7xl w-full relative z-10">
            <div className="flex flex-col items-center text-center">
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full glass-dark border border-[#007FFF]/30 text-[10px] font-black tracking-[0.3em] uppercase text-[#007FFF]"
              >
              ...
              <h1 className="text-[12vw] md:text-[15vw] font-black mb-6 tracking-tighter leading-[0.8] text-white mix-blend-difference">
        ...
        <div className="relative z-10 bg-black">
          ...
          {/* Portfolio Section */}
          <section id="portfolio" ref={portfolioRef} className="relative py-40 overflow-hidden">
              ...
              <div className="max-w-7xl mx-auto">
                <div className="flex justify-between items-center mb-20">
                  ...
                  <button 
                    ...
                    className="w-16 h-16 rounded-full glass flex items-center justify-center hover:bg-white hover:text-black transition-all"
                  >
