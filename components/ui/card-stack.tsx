            ...
            {showDots ? (
                <div className="mt-6 flex items-center justify-center gap-3">
                    ...
                    {activeItem.href ? (
                        ...
                        <div className="text-white/30 cursor-not-allowed">
                            <SquareArrowOutUpRight className="h-5 w-5" />
                        </div>
                    )}
                </div>
    ...
    return (
        <div className="relative h-full w-full">
            ...
            <div className="relative z-10 flex h-full flex-col justify-end p-5">
                ...
                {item.href && (
                    <button
                        className="mt-3 px-4 py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-lg text-sm font-medium text-white hover:bg-white/30 transition-colors"
                        onClick={(e) => {
                            e.stopPropagation();
